...
class _EmployeeFormScreenState extends ConsumerState<EmployeeFormScreen> {
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildCredentialFields(shiftsAsync),
  ...
  Widget _buildCredentialFields(AsyncValue<List<Shift>> shiftsAsync) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.stretch,
      children: [
        Text(
  ...
  Widget _buildSubmitButton(EmployeeFormState formState) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.stretch,
      children: [
        FilledButton(
          ...
          child: formState.isLoading
              ...
              : Text(
                  _isEditing ? 'GUARDAR CAMBIOS' : 'REGISTRAR EMPLEADO',
                ),
        ),
  ...
  Widget _buildDeleteButton(EmployeeFormState formState) {
