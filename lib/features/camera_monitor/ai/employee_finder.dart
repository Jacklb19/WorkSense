...
class EmployeeFinder {
  ...
  static const double _trackingBodyThreshold = 0.55;
  ...
  Future<FindResult> findInFrame({
    ...
    if (_lockedTrackingId != null) {
      ...
      if (tracked != null) {
        ...
        final score = _profile.matchScore(bodyScore: bodyScore);
    ...
    if (_lockedTrackingId == null || _consecutiveMisses >= _maxConsecutiveMisses) {
    ...
    // Perdimos el trackingId y no está en el umbral → fuera del área si hay gente
    _consecutiveMisses++;
    if (_consecutiveMisses >= _maxConsecutiveMisses) _lockedTrackingId = null;
